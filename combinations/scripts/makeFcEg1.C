...
TH1F *ht2 = _file0->Get("hToys_x=1.34_y=1.00");
TH1F *hd2 = _file0->Get("hData_x=1.34_y=1.00");
...
// ht2->Rebin(2);
 ...
 ht2->SetLineColor(1);
// ht2->SetLineWidth(2);
 ht2->Scale(1./ht2->Integral(1,ht2->GetNbinsX()));
 //find 68%
 ...
 bin95++;
 bin68++;
 std::cout << "Bins 68/95 "<< bin68 << " "<< bin95 <<std::endl;
 std::cout << "Integrals 68/95 "<< ht2->Integral(1,bin68)<< " "<< ht2->Integral(1,bin95)<<std::endl;
...
gPad->RedrawAxis();
 ...
 lat->DrawLatex(0.58,0.92,"m_{H}=125.8, #mu=1.34");
 leg->Draw();
